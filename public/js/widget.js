...
function initChatWidget(options = {}) {
  ...
  function injectStyles() {
    ...
    const css = `
    .cw-bubble{position:fixed;right:22px;bottom:22px;width:60px;height:60px;border-radius:50%;border:0;cursor:pointer;background:linear-gradient(135deg,#6c5ce7,#a29bfe);color:#fff;box-shadow:0 12px 30px -6px rgba(108,92,231,.5);z-index:200;display:grid;place-items:center;transition:transform .2s}
    .cw-bubble:hover{transform:scale(1.06)}
    .cw-panel{position:fixed;right:22px;bottom:94px;width:360px;max-width:calc(100vw - 36px);height:520px;max-height:72vh;background:#fff;border:1px solid #e6e8ee;border-radius:16px;display:none;flex-direction:column;overflow:hidden;z-index:200;box-shadow:0 24px 60px -12px rgba(108,92,231,.25);font-family:'Inter',system-ui,sans-serif}
    .cw-head{display:flex;align-items:center;justify-content:space-between;padding:14px 16px;background:linear-gradient(135deg,#6c5ce7,#a29bfe);color:#fff;font-family:'Inter',system-ui,sans-serif}
    ...
    .cw-msg{max-width:82%;padding:9px 13px;border-radius:14px;font-size:.9rem;line-height:1.45;word-wrap:break-word;font-family:'Inter',system-ui,sans-serif}
    .cw-in{align-self:flex-start;background:#fff;border:1px solid #e6e8ee;color:#0f172a;border-bottom-left-radius:4px}
    .cw-out{align-self:flex-end;background:linear-gradient(135deg,#6c5ce7,#a29bfe);color:#fff;border-bottom-right-radius:4px}
    ...
    .cw-input input{flex:1;padding:11px 14px;border-radius:12px;border:1px solid #e6e8ee;font-size:.9rem;font-family:'Inter',system-ui,sans-serif;color:#0f172a}
    .cw-input input:focus{outline:none;border-color:#6c5ce7;box-shadow:0 0 0 3px rgba(108,92,231,.15)}
    .cw-send{border:0;background:linear-gradient(135deg,#6c5ce7,#a29bfe);color:#fff;width:42px;border-radius:50%;cursor:pointer;font-size:1rem}`;
