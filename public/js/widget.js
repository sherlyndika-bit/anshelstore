...
function initChatWidget(options = {}) {
  ...
  function injectStyles() {
    ...
    const css = `
    .cw-bubble{position:fixed;right:22px;bottom:22px;width:60px;height:60px;border-radius:50%;border:0;cursor:pointer;background:linear-gradient(135deg,#7c3aed,#4f46e5);color:#fff;box-shadow:0 12px 30px -6px rgba(124,58,237,.55);z-index:200;display:grid;place-items:center;transition:transform .2s}
    ...
    .cw-head{display:flex;align-items:center;justify-content:space-between;padding:14px 16px;background:linear-gradient(135deg,#7c3aed,#4f46e5);color:#fff}
    ...
    .cw-out{align-self:flex-end;background:linear-gradient(135deg,#7c3aed,#4f46e5);color:#fff;border-bottom-right-radius:4px}
    ...
    .cw-input input:focus{outline:none;border-color:#8b5cf6;box-shadow:0 0 0 3px rgba(124,58,237,.15)}
    .cw-send{border:0;background:linear-gradient(135deg,#7c3aed,#4f46e5);color:#fff;width:42px;border-radius:50%;cursor:pointer;font-size:1rem}`;
