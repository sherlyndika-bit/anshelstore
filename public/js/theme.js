...
(function() {
  ...
  function injectPreloader() {
    ...
    p.innerHTML = '<div class="preloader-content"><img src="/images/logo.png" alt="Anshel Store Logo" class="preloader-logo"/><div class="preloader-bar"><div class="preloader-progress"></div></div></div>';
  ...
  document.addEventListener('click', (e) => {
    ...
    if (isInternal && !isNewTab && !isHash && !isAction) {
      ...
      if (p) {
        ...
        // Wait for the fast fade-in animation to complete before navigating
        setTimeout(() => {
          window.location.href = link.href;
        }, 150); // Reduced delay for snappier mobile feel
      } else {
        window.location.href = link.href;
      }
    }
