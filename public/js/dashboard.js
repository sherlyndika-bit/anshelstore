...
async function loadSettings() {
  ...
  $("setBannerImage").value = s.bannerImage || ""; $("setBannerLink").value = s.bannerLink || "";
...
$("saveSettings").addEventListener("click", async () => {
  const body = {
    ...
    settings: { heroTitle: $("setHeroTitle").value.trim(), heroImage: $("setHeroImage").value.trim(), heroSubtitle: $("setHeroSub").value.trim(), metaDescription: $("setMeta").value.trim(), logo: $("setLogo").value.trim(), bannerImage: $("setBannerImage").value.trim(), bannerLink: $("setBannerLink").value.trim(), layananTitle: $("setLayananTitle").value.trim(), layananDesc: $("setLayananDesc").value.trim(), topupTitle: $("setTopupTitle").value.trim(), topupDesc: $("setTopupDesc").value.trim(), articlesTitle: $("setArtikelTitle").value.trim(), social: { instagram: $("setIg").value.trim(), tiktok: $("setTt").value.trim(), youtube: $("setYt").value.trim() } },
  };
