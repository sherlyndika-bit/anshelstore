...
const target = `              <div><label class="block text-sm font-medium text-slate-700 mb-1">Cek-ID Game: URL API</label><input class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-primary outline-none" id="intGcUrl" placeholder="https://provider/check" /></div>
              <div><label class="block text-sm font-medium text-slate-700 mb-1">Cek-ID Game: API Key</label><input class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-primary outline-none" id="intGcKey" type="password" placeholder="******" /></div>
            </div>`;

const replacement = `              <div><label class="block text-sm font-medium text-slate-700 mb-1">Cek-ID Game: URL API</label><input class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-primary outline-none" id="intGcUrl" placeholder="https://provider/check" /></div>
              <div><label class="block text-sm font-medium text-slate-700 mb-1">Cek-ID Game: API Key</label><input class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-primary outline-none" id="intGcKey" type="password" placeholder="******" /></div>
